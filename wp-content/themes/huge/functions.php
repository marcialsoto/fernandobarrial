...
function krown_update_notice() {
	...
	if ( get_option( 'krown_huge_version' ) != '1.6.3' ) {

        echo '<div class="updated" style="position: relative;">
        	<h4>You have just updated to version 1.6.3 - <a style="text-decoration" href="' . admin_url( 'themes.php?page=ot-theme-options&krown_update_done_do=1#section_log' ) . '">Read the CHANGELOG</a></h4>';
...
function krown_update_done_do() {
    ...
    if ( isset( $_GET['krown_update_done_do'] ) && '1' == $_GET['krown_update_done_do'] ) {
        update_option( 'krown_huge_version', '1.6.3' );
	}
}
